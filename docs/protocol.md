...
- **unreleased** &mdash; `IBowireStreamingWithWireBytes` (recorded subscriptions replay 1:1), `_tacticalapi:objectCount` / `_tacticalapi:responseBytes` / `_tacticalapi:warning` on every unary result, `TacticalApiMockEmitter.Completion`.
